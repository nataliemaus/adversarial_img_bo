    ...
    def get_related_vocab(self,):
        if self.optimal_class == "cat":
            ...
            related_vocab = [
                ...
                'challengers', 'burgring', 'valet', 'holden',
                'sebring', 'havana', 'pontiac', 'ocon', 'rpm',
                'chery', 'lancia', 'pickup', 'stis', 'accelerator', 
                'gtx', 'racing', 'wku', 'camry', 'formula',
                'saab', 'rollout', 'penske', 'gle', "duster", 'gti',
                'cab', "taxi", 'grandprix', "prix", 'challenger', 
